...
def main(**kwargs):
    ...
    c = dnnlib.EasyDict()
    c.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.precomputed_dataset', path=opts.data, use_labels=opts.cond, xflip=opts.xflip, cache=opts.cache, fetch_raw=opts.fetch_raw)
